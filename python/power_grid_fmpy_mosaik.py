...
META = {
    ...
    'models': {
        'pandapower_LV': {
            'public': True,
            'params': [],
            'attrs': ['tap', 'L_3', 'L_4', 'V3',],
            # 'attrs': ['tap', 'L_3', 'L_4', 'V3', 'v4'],
        },
    },
}

class pandapower_LV(mosaik_api.Simulator):
    ...
    def __init__(self):
        ...
        self.current_tap = 0                # current tap position of transformer
    ...
    def init(self, sid, time_resolution, fmu_filename, instance_name, start_time = 0, stop_time = 0):
        ...
        self.vr_inputs = [self.vrs['P_load3'], self.vrs['P_load4'], self.vrs['trafo_tap']]     
