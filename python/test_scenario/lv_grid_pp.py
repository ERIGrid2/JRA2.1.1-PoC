...
def create_network():
    """create busbars as per TC-3 powerfactory model from ERIGrid 1. 
    Network consists of one HV bus, three LV buses, an OLTC, and two loads
    """
...
def save_nw():
    ...
    pandapower_net_file = os.path.join(os.getcwd(), 'erigrid_lv_nw.p') 
